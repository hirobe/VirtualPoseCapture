...
public struct VmdBone
{
    public VmdBone(UnityHumanoidVMDRecorder.BoneNames name, Vector3 pos, Quaternion rot)
    {
        Name = name;
        Position = pos;
        Rotation = rot;
    }
    public UnityHumanoidVMDRecorder.BoneNames Name;
...
public class UnityHumanoidVMDRecorder : MonoBehaviour
{
    ...
    public SampleBonesSendBundle SampleBonesSendBundle;
    ...
    void SaveFrame()
    {
        ...
        List<VmdBone> vmdBones = new List<VmdBone>();
        ...
        foreach (BoneNames boneName in BoneDictionary.Keys)
        {
            ...
            if (boneName == BoneNames.右足ＩＫ || boneName == BoneNames.左足ＩＫ)
            {
                ...
                vmdBones.Add(new VmdBone(boneName, ikPosition * DefaultBoneAmplifier, ikRotation));
            ...
            if (boneGhost != null && boneGhost.GhostDictionary.Keys.Contains(boneName))
            {
                if (boneGhost.GhostDictionary[boneName].ghost == null || !boneGhost.GhostDictionary[boneName].enabled)
                {
                    ...
                    vmdBones.Add(new VmdBone(boneName, Vector3.zero, Quaternion.identity));
                ...
                vmdBones.Add(new VmdBone(boneName, new Vector3(-boneVector.x, boneVector.y, -boneVector.z) * DefaultBoneAmplifier, 
                    new Quaternion(-boneQuatenion.x, boneQuatenion.y, -boneQuatenion.z, boneQuatenion.w)));
            ...
            if (boneName == BoneNames.全ての親)
            {
                ...
                vmdBones.Add(new VmdBone(boneName,vmdPosition * DefaultBoneAmplifier + ParentOfAllOffset, 
                    vmdRotation));
            ...
            else
            {
                ...
                vmdBones.Add(new VmdBone(boneName,vmdPosition * DefaultBoneAmplifier, 
                    vmdRotation));

            }
        }
        SampleBonesSendBundle.SendVMD(vmdBones);
    }
    ...
    class BoneGhost
    {
        ...
        public BoneGhost(Animator animator, Dictionary<BoneNames, Transform> boneDictionary, bool useBottomCenter)
        {
            ...
            foreach (BoneNames boneName in boneDictionary.Keys)
            {
                ...
                {
                    GhostDictionary[boneName].ghost.SetParent(ParentObject.transform);
                    continue;
                }
